...
const DEFAULT_ACTIVITIES: Activity[] = [
  { id: "act-1", userId: "student-13", userName: "김나연", grade: 3, date: "2026-07-20T17:30:00Z", distance: 5.2, duration: 1620, pace: "5:11", memo: "동강 영산강 강변길 따라 저녁 어슬런데이 완주! 무지 시원함!", path: generateMockPath(0.001, -0.001, 8), stampsEarned: 1 },
  { id: "act-2", userId: "student-05", userName: "김가영", grade: 2, date: "2026-07-20T08:15:00Z", distance: 4.1, duration: 1400, pace: "5:41", memo: "아침 공기 짱이다! 다함께 열심히 달려보아요!", path: generateMockPath(-0.001, 0.002, 6), stampsEarned: 1 },
  { id: "act-3", userId: "student-11", userName: "차근영", grade: 2, date: "2026-07-19T18:00:00Z", distance: 3.5, duration: 1100, pace: "5:14", memo: "방과 후에 친구들과 영산강 데크길 한 바퀴 돌았습니다.", path: generateMockPath(0.002, 0.001, 5), stampsEarned: 1 },
  { id: "act-4", userId: "student-19", userName: "정혜승", grade: 3, date: "2026-07-19T07:20:00Z", distance: 6.0, duration: 2160, pace: "6:00", memo: "주말 아침 어슬런 완료! 주간 미션 깨서 신난다.", path: generateMockPath(-0.002, -0.002, 7), stampsEarned: 2 }
];
...
const DEFAULT_POSTS: Post[] = [
  {
    ...
    duration: 1620,
    pace: "5:11",
    path: generateMockPath(0.001, -0.001, 8),
  ...
  },
  {
    ...
    duration: 1400,
    pace: "5:41",
    path: generateMockPath(-0.001, 0.002, 6),
